  ...
  Future<void> _init() async {
    ...
    _webrtc.onRemoteStream = (stream) {
      ...
      setState(() {
        ...
        _connected  = true;
setState(() => _statusText = AppLocalizations.of(context)!.connected);
      });
      _startCallTimer();
    ...
    try {
      ...
      if (widget.isCaller) {
        if (mounted) setState(() => _statusText = AppLocalizations.of(context)!.ringing);
        ...
        if (mounted) setState(
            () => _statusText = AppLocalizations.of(context)!.connecting,
          );
      ...
      if (mounted) {
        Get.snackbar(AppLocalizations.of(context)!.callError, e.toString(),
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(AppLocalizations.of(context)!.settingUpCall,
